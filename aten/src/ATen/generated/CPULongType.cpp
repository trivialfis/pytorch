...
Tensor & CPULongType::zeros_out(Tensor & result, IntList size) const {
    auto result_ = checked_cast_tensor<CPULongTensor>(result.pImpl,"result",0, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THLongTensor_zeros(result_->tensor, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPULongType::zeros(IntList size) const {
...
Tensor & CPULongType::ones_out(Tensor & result, IntList size) const {
    auto result_ = checked_cast_tensor<CPULongTensor>(result.pImpl,"result",0, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THLongTensor_ones(result_->tensor, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPULongType::ones(IntList size) const {
    auto result_ = new CPULongTensor(context);
    auto result = Tensor(result_, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THLongTensor_ones(result_->tensor, size_);
...
Tensor & CPULongType::index_copy_(Tensor & self, int64_t dim, const Tensor & index, const Tensor & source) const {
    auto self_ = checked_cast_tensor<CPULongTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
    auto index_ = checked_cast_tensor<CPULongTensor>(index.pImpl,"index",3, false);
...
Tensor & CPULongType::range_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    auto result_ = checked_cast_tensor<CPULongTensor>(result.pImpl,"result",0, false);
...
Tensor CPULongType::range(Scalar start, Scalar end, Scalar step) const {
    auto result_ = new CPULongTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
...
Tensor & CPULongType::arange_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    auto result_ = checked_cast_tensor<CPULongTensor>(result.pImpl,"result",0, false);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
    auto step_ = step.toLong();
...
Tensor CPULongType::arange(Scalar start, Scalar end, Scalar step) const {
    auto result_ = new CPULongTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
...
Tensor & CPULongType::arange_out(Tensor & result, Scalar end) const {
    auto result_ = checked_cast_tensor<CPULongTensor>(result.pImpl,"result",0, false);
    auto end_ = end.toLong();
    THLongTensor_arange(result_->tensor, 0, end_, 1);
    return result;
}
Tensor CPULongType::arange(Scalar end) const {
    auto result_ = new CPULongTensor(context);
    auto result = Tensor(result_, false);
    auto end_ = end.toLong();
    THLongTensor_arange(result_->tensor, 0, end_, 1);
...
Tensor CPULongType::abs(const Tensor & self) const {
    auto result_ = new CPULongTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPULongTensor>(self.pImpl,"self",1, false);
    THLongTensor_abs(result_->tensor, self_->tensor);
...
Tensor & CPULongType::abs_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPULongTensor>(self.pImpl,"self",1, false);
    THLongTensor_abs(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPULongType::sum(const Tensor & self, int64_t dim, bool keepdim) const {
    auto result_ = new CPULongTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPULongTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor CPULongType::prod(const Tensor & self, int64_t dim, bool keepdim) const {
    auto result_ = new CPULongTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPULongTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor & CPULongType::eye_out(Tensor & result, int64_t n, int64_t m) const {
    auto result_ = checked_cast_tensor<CPULongTensor>(result.pImpl,"result",0, false);
    THLongTensor_eye(result_->tensor, n, m);
    return result;
}
Tensor CPULongType::eye(int64_t n, int64_t m) const {
    auto result_ = new CPULongTensor(context);
    auto result = Tensor(result_, false);
    THLongTensor_eye(result_->tensor, n, m);
    return result;
...
Tensor & CPULongType::randperm_out(Tensor & result, int64_t n, Generator * generator) const {
    auto result_ = checked_cast_tensor<CPULongTensor>(result.pImpl,"result",0, false);
    auto generator_ = check_generator<CPUGenerator>(generator, &context->defaultGenerator(backend()));
    THLongTensor_randperm(result_->tensor, generator_->generator, n);
    return result;
}
Tensor CPULongType::randperm(int64_t n, Generator * generator) const {
    auto result_ = new CPULongTensor(context);
    auto result = Tensor(result_, false);
    auto generator_ = check_generator<CPUGenerator>(generator, &context->defaultGenerator(backend()));
    THLongTensor_randperm(result_->tensor, generator_->generator, n);
...
Tensor & CPULongType::reshape_(Tensor & self, IntList size, IntList stride) const {
    auto self_ = checked_cast_tensor<CPULongTensor>(self.pImpl,"self",1, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    auto stride_ = THLongStorageView::makeFromStride(stride, is_noelem_tensor_size(size));
    THLongTensor_resize(self_->tensor, size_, stride_);
    self_->maybeScalar(size.size() == 0);
    return self;
}
