...
Tensor & CPUFloatType::zeros_out(Tensor & result, IntList size) const {
    auto result_ = checked_cast_tensor<CPUFloatTensor>(result.pImpl,"result",0, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THFloatTensor_zeros(result_->tensor, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPUFloatType::zeros(IntList size) const {
...
Tensor & CPUFloatType::ones_out(Tensor & result, IntList size) const {
    auto result_ = checked_cast_tensor<CPUFloatTensor>(result.pImpl,"result",0, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THFloatTensor_ones(result_->tensor, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPUFloatType::ones(IntList size) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THFloatTensor_ones(result_->tensor, size_);
...
Tensor & CPUFloatType::index_copy_(Tensor & self, int64_t dim, const Tensor & index, const Tensor & source) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
    auto index_ = checked_cast_tensor<CPULongTensor>(index.pImpl,"index",3, false);
...
Tensor & CPUFloatType::range_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    auto result_ = checked_cast_tensor<CPUFloatTensor>(result.pImpl,"result",0, false);
...
Tensor CPUFloatType::range(Scalar start, Scalar end, Scalar step) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toDouble();
    auto end_ = end.toDouble();
...
Tensor & CPUFloatType::arange_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    auto result_ = checked_cast_tensor<CPUFloatTensor>(result.pImpl,"result",0, false);
    auto start_ = start.toDouble();
    auto end_ = end.toDouble();
    auto step_ = step.toDouble();
...
Tensor CPUFloatType::arange(Scalar start, Scalar end, Scalar step) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toDouble();
    auto end_ = end.toDouble();
...
Tensor & CPUFloatType::arange_out(Tensor & result, Scalar end) const {
    auto result_ = checked_cast_tensor<CPUFloatTensor>(result.pImpl,"result",0, false);
    auto end_ = end.toDouble();
    THFloatTensor_arange(result_->tensor, 0, end_, 1);
    return result;
}
Tensor CPUFloatType::arange(Scalar end) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto end_ = end.toDouble();
    THFloatTensor_arange(result_->tensor, 0, end_, 1);
...
Tensor CPUFloatType::abs(const Tensor & self) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_abs(result_->tensor, self_->tensor);
...
Tensor & CPUFloatType::abs_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_abs(self_->tensor, self_->tensor);
    return self;
}
...
Tensor & CPUFloatType::log_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_log(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUFloatType::log(const Tensor & self) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_log(result_->tensor, self_->tensor);
...
Tensor & CPUFloatType::exp_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_exp(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUFloatType::exp(const Tensor & self) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_exp(result_->tensor, self_->tensor);
...
Tensor & CPUFloatType::cos_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_cos(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUFloatType::cos(const Tensor & self) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_cos(result_->tensor, self_->tensor);
...
Tensor & CPUFloatType::sin_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_sin(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUFloatType::sin(const Tensor & self) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_sin(result_->tensor, self_->tensor);
...
Tensor & CPUFloatType::sqrt_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_sqrt(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUFloatType::sqrt(const Tensor & self) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_sqrt(result_->tensor, self_->tensor);
...
Tensor & CPUFloatType::ceil_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_ceil(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUFloatType::ceil(const Tensor & self) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_ceil(result_->tensor, self_->tensor);
...
Tensor & CPUFloatType::floor_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_floor(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUFloatType::floor(const Tensor & self) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_floor(result_->tensor, self_->tensor);
...
Tensor & CPUFloatType::round_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_round(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUFloatType::round(const Tensor & self) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_round(result_->tensor, self_->tensor);
...
Tensor & CPUFloatType::trunc_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_trunc(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUFloatType::trunc(const Tensor & self) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    THFloatTensor_trunc(result_->tensor, self_->tensor);
...
Tensor CPUFloatType::linspace(Scalar start, Scalar end, int64_t steps) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toFloat();
    auto end_ = end.toFloat();
...
Tensor & CPUFloatType::logspace_out(Tensor & result, Scalar start, Scalar end, int64_t steps) const {
    auto result_ = checked_cast_tensor<CPUFloatTensor>(result.pImpl,"result",0, false);
    auto start_ = start.toFloat();
    auto end_ = end.toFloat();
...
Tensor CPUFloatType::logspace(Scalar start, Scalar end, int64_t steps) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toFloat();
    auto end_ = end.toFloat();
...
Tensor CPUFloatType::sum(const Tensor & self, int64_t dim, bool keepdim) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor CPUFloatType::prod(const Tensor & self, int64_t dim, bool keepdim) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor & CPUFloatType::eye_out(Tensor & result, int64_t n, int64_t m) const {
    auto result_ = checked_cast_tensor<CPUFloatTensor>(result.pImpl,"result",0, false);
    THFloatTensor_eye(result_->tensor, n, m);
    return result;
}
Tensor CPUFloatType::eye(int64_t n, int64_t m) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    THFloatTensor_eye(result_->tensor, n, m);
    return result;
...
Tensor & CPUFloatType::randperm_out(Tensor & result, int64_t n, Generator * generator) const {
    ...
    THFloatTensor_randperm(result_->tensor, generator_->generator, n);
    return result;
}
Tensor CPUFloatType::randperm(int64_t n, Generator * generator) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto generator_ = check_generator<CPUGenerator>(generator, &context->defaultGenerator(backend()));
    THFloatTensor_randperm(result_->tensor, generator_->generator, n);
...
Tensor & CPUFloatType::rand_out(Tensor & result, IntList size, Generator * generator) const {
    auto result_ = checked_cast_tensor<CPUFloatTensor>(result.pImpl,"result",0, false);
    auto generator_ = check_generator<CPUGenerator>(generator, &context->defaultGenerator(backend()));
    auto size_ = THLongStorageView::makeFromSize(size);
    THFloatTensor_rand(result_->tensor, generator_->generator, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPUFloatType::rand(IntList size, Generator * generator) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto generator_ = check_generator<CPUGenerator>(generator, &context->defaultGenerator(backend()));
    auto size_ = THLongStorageView::makeFromSize(size);
...
Tensor & CPUFloatType::randn_out(Tensor & result, IntList size, Generator * generator) const {
    auto result_ = checked_cast_tensor<CPUFloatTensor>(result.pImpl,"result",0, false);
    auto generator_ = check_generator<CPUGenerator>(generator, &context->defaultGenerator(backend()));
    auto size_ = THLongStorageView::makeFromSize(size);
    THFloatTensor_randn(result_->tensor, generator_->generator, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPUFloatType::randn(IntList size, Generator * generator) const {
    auto result_ = new CPUFloatTensor(context);
    auto result = Tensor(result_, false);
    auto generator_ = check_generator<CPUGenerator>(generator, &context->defaultGenerator(backend()));
    auto size_ = THLongStorageView::makeFromSize(size);
...
Tensor & CPUFloatType::reshape_(Tensor & self, IntList size, IntList stride) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    auto stride_ = THLongStorageView::makeFromStride(stride, is_noelem_tensor_size(size));
    THFloatTensor_resize(self_->tensor, size_, stride_);
    self_->maybeScalar(size.size() == 0);
    return self;
}
...
Tensor & CPUFloatType::upsample_linear1d_forward_out(Tensor & output, const Tensor & self, IntList output_size) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    auto output_size_ = check_intlist<1>(output_size, "output_size", 2);
    auto output_ = checked_cast_tensor<CPUFloatTensor>(output.pImpl,"output",2, false);
    THNN_FloatTemporalUpSamplingLinear_updateOutput(context->thc_state, self_->tensor, output_->tensor, output_size_[0]);
    return output;
}
Tensor CPUFloatType::upsample_linear1d_forward(const Tensor & self, IntList output_size) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    auto output_size_ = check_intlist<1>(output_size, "output_size", 2);
    auto output_ = new CPUFloatTensor(context);
    auto output = Tensor(output_, false);
...
Tensor & CPUFloatType::upsample_linear1d_backward_out(Tensor & grad_input, const Tensor & grad_output, IntList output_size, IntList input_size) const {
    auto grad_output_ = checked_cast_tensor<CPUFloatTensor>(grad_output.pImpl,"grad_output",1, false);
    auto output_size_ = check_intlist<1>(output_size, "output_size", 2);
    auto grad_input_ = checked_cast_tensor<CPUFloatTensor>(grad_input.pImpl,"grad_input",2, false);
    auto input_size_ = check_intlist<3>(input_size, "input_size", 3);
    THNN_FloatTemporalUpSamplingLinear_updateGradInput(context->thc_state, grad_output_->tensor, grad_input_->tensor, input_size_[0], input_size_[1], input_size_[2], output_size_[0]);
    grad_input_->maybeScalar(false);
    return grad_input;
}
Tensor CPUFloatType::upsample_linear1d_backward(const Tensor & grad_output, IntList output_size, IntList input_size) const {
    auto grad_output_ = checked_cast_tensor<CPUFloatTensor>(grad_output.pImpl,"grad_output",1, false);
    auto output_size_ = check_intlist<1>(output_size, "output_size", 2);
    auto grad_input_ = new CPUFloatTensor(context);
    auto grad_input = Tensor(grad_input_, false);
...
Tensor & CPUFloatType::upsample_bilinear2d_forward_out(Tensor & output, const Tensor & self, IntList output_size) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    auto output_size_ = check_intlist<2>(output_size, "output_size", 2);
    auto output_ = checked_cast_tensor<CPUFloatTensor>(output.pImpl,"output",2, false);
    THNN_FloatSpatialUpSamplingBilinear_updateOutput(context->thc_state, self_->tensor, output_->tensor, output_size_[0], output_size_[1]);
    return output;
}
Tensor CPUFloatType::upsample_bilinear2d_forward(const Tensor & self, IntList output_size) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    auto output_size_ = check_intlist<2>(output_size, "output_size", 2);
    auto output_ = new CPUFloatTensor(context);
    auto output = Tensor(output_, false);
...
Tensor & CPUFloatType::upsample_bilinear2d_backward_out(Tensor & grad_input, const Tensor & grad_output, IntList output_size, IntList input_size) const {
    auto grad_output_ = checked_cast_tensor<CPUFloatTensor>(grad_output.pImpl,"grad_output",1, false);
    auto output_size_ = check_intlist<2>(output_size, "output_size", 2);
    auto grad_input_ = checked_cast_tensor<CPUFloatTensor>(grad_input.pImpl,"grad_input",2, false);
    auto input_size_ = check_intlist<4>(input_size, "input_size", 3);
    THNN_FloatSpatialUpSamplingBilinear_updateGradInput(context->thc_state, grad_output_->tensor, grad_input_->tensor, input_size_[0], input_size_[1], input_size_[2], input_size_[3], output_size_[0], output_size_[1]);
    grad_input_->maybeScalar(false);
    return grad_input;
}
Tensor CPUFloatType::upsample_bilinear2d_backward(const Tensor & grad_output, IntList output_size, IntList input_size) const {
    auto grad_output_ = checked_cast_tensor<CPUFloatTensor>(grad_output.pImpl,"grad_output",1, false);
    auto output_size_ = check_intlist<2>(output_size, "output_size", 2);
    auto grad_input_ = new CPUFloatTensor(context);
    auto grad_input = Tensor(grad_input_, false);
...
Tensor & CPUFloatType::upsample_trilinear3d_forward_out(Tensor & output, const Tensor & self, IntList output_size) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    auto output_size_ = check_intlist<3>(output_size, "output_size", 2);
    auto output_ = checked_cast_tensor<CPUFloatTensor>(output.pImpl,"output",2, false);
    THNN_FloatVolumetricUpSamplingTrilinear_updateOutput(context->thc_state, self_->tensor, output_->tensor, output_size_[0], output_size_[1], output_size_[2]);
    return output;
}
Tensor CPUFloatType::upsample_trilinear3d_forward(const Tensor & self, IntList output_size) const {
    auto self_ = checked_cast_tensor<CPUFloatTensor>(self.pImpl,"self",1, false);
    auto output_size_ = check_intlist<3>(output_size, "output_size", 2);
    auto output_ = new CPUFloatTensor(context);
    auto output = Tensor(output_, false);
...
Tensor & CPUFloatType::upsample_trilinear3d_backward_out(Tensor & grad_input, const Tensor & grad_output, IntList output_size, IntList input_size) const {
    auto grad_output_ = checked_cast_tensor<CPUFloatTensor>(grad_output.pImpl,"grad_output",1, false);
    auto output_size_ = check_intlist<3>(output_size, "output_size", 2);
    auto grad_input_ = checked_cast_tensor<CPUFloatTensor>(grad_input.pImpl,"grad_input",2, false);
    auto input_size_ = check_intlist<5>(input_size, "input_size", 3);
    THNN_FloatVolumetricUpSamplingTrilinear_updateGradInput(context->thc_state, grad_output_->tensor, grad_input_->tensor, input_size_[0], input_size_[1], input_size_[2], input_size_[3], input_size_[4], output_size_[0], output_size_[1], output_size_[2]);
    grad_input_->maybeScalar(false);
    return grad_input;
}
Tensor CPUFloatType::upsample_trilinear3d_backward(const Tensor & grad_output, IntList output_size, IntList input_size) const {
    auto grad_output_ = checked_cast_tensor<CPUFloatTensor>(grad_output.pImpl,"grad_output",1, false);
    auto output_size_ = check_intlist<3>(output_size, "output_size", 2);
    auto grad_input_ = new CPUFloatTensor(context);
    auto grad_input = Tensor(grad_input_, false);
