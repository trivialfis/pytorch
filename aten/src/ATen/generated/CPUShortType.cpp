...
Tensor & CPUShortType::zeros_out(Tensor & result, IntList size) const {
    auto result_ = checked_cast_tensor<CPUShortTensor>(result.pImpl,"result",0, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THShortTensor_zeros(result_->tensor, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPUShortType::zeros(IntList size) const {
...
Tensor & CPUShortType::ones_out(Tensor & result, IntList size) const {
    auto result_ = checked_cast_tensor<CPUShortTensor>(result.pImpl,"result",0, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THShortTensor_ones(result_->tensor, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPUShortType::ones(IntList size) const {
    auto result_ = new CPUShortTensor(context);
    auto result = Tensor(result_, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THShortTensor_ones(result_->tensor, size_);
...
Tensor & CPUShortType::index_copy_(Tensor & self, int64_t dim, const Tensor & index, const Tensor & source) const {
    auto self_ = checked_cast_tensor<CPUShortTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
    auto index_ = checked_cast_tensor<CPULongTensor>(index.pImpl,"index",3, false);
...
Tensor & CPUShortType::range_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    auto result_ = checked_cast_tensor<CPUShortTensor>(result.pImpl,"result",0, false);
...
Tensor CPUShortType::range(Scalar start, Scalar end, Scalar step) const {
    auto result_ = new CPUShortTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
...
Tensor & CPUShortType::arange_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    auto result_ = checked_cast_tensor<CPUShortTensor>(result.pImpl,"result",0, false);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
    auto step_ = step.toLong();
...
Tensor CPUShortType::arange(Scalar start, Scalar end, Scalar step) const {
    auto result_ = new CPUShortTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
...
Tensor & CPUShortType::arange_out(Tensor & result, Scalar end) const {
    auto result_ = checked_cast_tensor<CPUShortTensor>(result.pImpl,"result",0, false);
    auto end_ = end.toLong();
    THShortTensor_arange(result_->tensor, 0, end_, 1);
    return result;
}
Tensor CPUShortType::arange(Scalar end) const {
    auto result_ = new CPUShortTensor(context);
    auto result = Tensor(result_, false);
    auto end_ = end.toLong();
    THShortTensor_arange(result_->tensor, 0, end_, 1);
...
Tensor CPUShortType::abs(const Tensor & self) const {
    auto result_ = new CPUShortTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUShortTensor>(self.pImpl,"self",1, false);
    THShortTensor_abs(result_->tensor, self_->tensor);
...
Tensor & CPUShortType::abs_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUShortTensor>(self.pImpl,"self",1, false);
    THShortTensor_abs(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUShortType::sum(const Tensor & self, int64_t dim, bool keepdim) const {
    auto result_ = new CPUShortTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUShortTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor CPUShortType::prod(const Tensor & self, int64_t dim, bool keepdim) const {
    auto result_ = new CPUShortTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUShortTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor & CPUShortType::eye_out(Tensor & result, int64_t n, int64_t m) const {
    auto result_ = checked_cast_tensor<CPUShortTensor>(result.pImpl,"result",0, false);
    THShortTensor_eye(result_->tensor, n, m);
    return result;
}
Tensor CPUShortType::eye(int64_t n, int64_t m) const {
    auto result_ = new CPUShortTensor(context);
    auto result = Tensor(result_, false);
    THShortTensor_eye(result_->tensor, n, m);
    return result;
...
Tensor & CPUShortType::randperm_out(Tensor & result, int64_t n, Generator * generator) const {
    ...
    THShortTensor_randperm(result_->tensor, generator_->generator, n);
    return result;
}
Tensor CPUShortType::randperm(int64_t n, Generator * generator) const {
    auto result_ = new CPUShortTensor(context);
    auto result = Tensor(result_, false);
    auto generator_ = check_generator<CPUGenerator>(generator, &context->defaultGenerator(backend()));
    THShortTensor_randperm(result_->tensor, generator_->generator, n);
...
Tensor & CPUShortType::reshape_(Tensor & self, IntList size, IntList stride) const {
    auto self_ = checked_cast_tensor<CPUShortTensor>(self.pImpl,"self",1, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    auto stride_ = THLongStorageView::makeFromStride(stride, is_noelem_tensor_size(size));
    THShortTensor_resize(self_->tensor, size_, stride_);
    self_->maybeScalar(size.size() == 0);
    return self;
}
