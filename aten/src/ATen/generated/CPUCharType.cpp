...
Tensor & CPUCharType::zeros_out(Tensor & result, IntList size) const {
    auto result_ = checked_cast_tensor<CPUCharTensor>(result.pImpl,"result",0, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THCharTensor_zeros(result_->tensor, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPUCharType::zeros(IntList size) const {
...
Tensor & CPUCharType::ones_out(Tensor & result, IntList size) const {
    auto result_ = checked_cast_tensor<CPUCharTensor>(result.pImpl,"result",0, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THCharTensor_ones(result_->tensor, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPUCharType::ones(IntList size) const {
    auto result_ = new CPUCharTensor(context);
    auto result = Tensor(result_, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THCharTensor_ones(result_->tensor, size_);
...
Tensor & CPUCharType::index_copy_(Tensor & self, int64_t dim, const Tensor & index, const Tensor & source) const {
    auto self_ = checked_cast_tensor<CPUCharTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
    auto index_ = checked_cast_tensor<CPULongTensor>(index.pImpl,"index",3, false);
...
Tensor & CPUCharType::range_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    auto result_ = checked_cast_tensor<CPUCharTensor>(result.pImpl,"result",0, false);
...
Tensor CPUCharType::range(Scalar start, Scalar end, Scalar step) const {
    auto result_ = new CPUCharTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
...
Tensor & CPUCharType::arange_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    auto result_ = checked_cast_tensor<CPUCharTensor>(result.pImpl,"result",0, false);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
    auto step_ = step.toLong();
...
Tensor CPUCharType::arange(Scalar start, Scalar end, Scalar step) const {
    auto result_ = new CPUCharTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
...
Tensor & CPUCharType::arange_out(Tensor & result, Scalar end) const {
    auto result_ = checked_cast_tensor<CPUCharTensor>(result.pImpl,"result",0, false);
    auto end_ = end.toLong();
    THCharTensor_arange(result_->tensor, 0, end_, 1);
    return result;
}
Tensor CPUCharType::arange(Scalar end) const {
    auto result_ = new CPUCharTensor(context);
    auto result = Tensor(result_, false);
    auto end_ = end.toLong();
    THCharTensor_arange(result_->tensor, 0, end_, 1);
...
Tensor CPUCharType::sum(const Tensor & self, int64_t dim, bool keepdim) const {
    auto result_ = new CPUCharTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUCharTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor CPUCharType::prod(const Tensor & self, int64_t dim, bool keepdim) const {
    auto result_ = new CPUCharTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUCharTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor & CPUCharType::eye_out(Tensor & result, int64_t n, int64_t m) const {
    auto result_ = checked_cast_tensor<CPUCharTensor>(result.pImpl,"result",0, false);
    THCharTensor_eye(result_->tensor, n, m);
    return result;
}
Tensor CPUCharType::eye(int64_t n, int64_t m) const {
    auto result_ = new CPUCharTensor(context);
    auto result = Tensor(result_, false);
    THCharTensor_eye(result_->tensor, n, m);
    return result;
...
Tensor & CPUCharType::randperm_out(Tensor & result, int64_t n, Generator * generator) const {
    ...
    THCharTensor_randperm(result_->tensor, generator_->generator, n);
    return result;
}
Tensor CPUCharType::randperm(int64_t n, Generator * generator) const {
    auto result_ = new CPUCharTensor(context);
    auto result = Tensor(result_, false);
    auto generator_ = check_generator<CPUGenerator>(generator, &context->defaultGenerator(backend()));
    THCharTensor_randperm(result_->tensor, generator_->generator, n);
...
Tensor & CPUCharType::reshape_(Tensor & self, IntList size, IntList stride) const {
    auto self_ = checked_cast_tensor<CPUCharTensor>(self.pImpl,"self",1, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    auto stride_ = THLongStorageView::makeFromStride(stride, is_noelem_tensor_size(size));
    THCharTensor_resize(self_->tensor, size_, stride_);
    self_->maybeScalar(size.size() == 0);
    return self;
}
