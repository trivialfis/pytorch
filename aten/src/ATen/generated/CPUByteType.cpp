...
Tensor & CPUByteType::zeros_out(Tensor & result, IntList size) const {
    auto result_ = checked_cast_tensor<CPUByteTensor>(result.pImpl,"result",0, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THByteTensor_zeros(result_->tensor, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPUByteType::zeros(IntList size) const {
...
Tensor & CPUByteType::ones_out(Tensor & result, IntList size) const {
    auto result_ = checked_cast_tensor<CPUByteTensor>(result.pImpl,"result",0, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THByteTensor_ones(result_->tensor, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPUByteType::ones(IntList size) const {
    auto result_ = new CPUByteTensor(context);
    auto result = Tensor(result_, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THByteTensor_ones(result_->tensor, size_);
...
Tensor & CPUByteType::index_copy_(Tensor & self, int64_t dim, const Tensor & index, const Tensor & source) const {
    auto self_ = checked_cast_tensor<CPUByteTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
    auto index_ = checked_cast_tensor<CPULongTensor>(index.pImpl,"index",3, false);
...
Tensor & CPUByteType::range_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    auto result_ = checked_cast_tensor<CPUByteTensor>(result.pImpl,"result",0, false);
...
Tensor CPUByteType::range(Scalar start, Scalar end, Scalar step) const {
    auto result_ = new CPUByteTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
...
Tensor & CPUByteType::arange_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    auto result_ = checked_cast_tensor<CPUByteTensor>(result.pImpl,"result",0, false);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
    auto step_ = step.toLong();
...
Tensor CPUByteType::arange(Scalar start, Scalar end, Scalar step) const {
    auto result_ = new CPUByteTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
...
Tensor & CPUByteType::arange_out(Tensor & result, Scalar end) const {
    auto result_ = checked_cast_tensor<CPUByteTensor>(result.pImpl,"result",0, false);
    auto end_ = end.toLong();
    THByteTensor_arange(result_->tensor, 0, end_, 1);
    return result;
}
Tensor CPUByteType::arange(Scalar end) const {
    auto result_ = new CPUByteTensor(context);
    auto result = Tensor(result_, false);
    auto end_ = end.toLong();
    THByteTensor_arange(result_->tensor, 0, end_, 1);
...
Tensor CPUByteType::sum(const Tensor & self, int64_t dim, bool keepdim) const {
    auto result_ = new CPUByteTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUByteTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor CPUByteType::prod(const Tensor & self, int64_t dim, bool keepdim) const {
    auto result_ = new CPUByteTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUByteTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor & CPUByteType::eye_out(Tensor & result, int64_t n, int64_t m) const {
    auto result_ = checked_cast_tensor<CPUByteTensor>(result.pImpl,"result",0, false);
    THByteTensor_eye(result_->tensor, n, m);
    return result;
}
Tensor CPUByteType::eye(int64_t n, int64_t m) const {
    auto result_ = new CPUByteTensor(context);
    auto result = Tensor(result_, false);
    THByteTensor_eye(result_->tensor, n, m);
    return result;
...
Tensor & CPUByteType::randperm_out(Tensor & result, int64_t n, Generator * generator) const {
    ...
    THByteTensor_randperm(result_->tensor, generator_->generator, n);
    return result;
}
Tensor CPUByteType::randperm(int64_t n, Generator * generator) const {
    auto result_ = new CPUByteTensor(context);
    auto result = Tensor(result_, false);
    auto generator_ = check_generator<CPUGenerator>(generator, &context->defaultGenerator(backend()));
    THByteTensor_randperm(result_->tensor, generator_->generator, n);
...
Tensor & CPUByteType::reshape_(Tensor & self, IntList size, IntList stride) const {
    auto self_ = checked_cast_tensor<CPUByteTensor>(self.pImpl,"self",1, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    auto stride_ = THLongStorageView::makeFromStride(stride, is_noelem_tensor_size(size));
    THByteTensor_resize(self_->tensor, size_, stride_);
    self_->maybeScalar(size.size() == 0);
    return self;
}
