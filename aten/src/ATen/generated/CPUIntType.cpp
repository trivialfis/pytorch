...
Tensor & CPUIntType::zeros_out(Tensor & result, IntList size) const {
    auto result_ = checked_cast_tensor<CPUIntTensor>(result.pImpl,"result",0, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THIntTensor_zeros(result_->tensor, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPUIntType::zeros(IntList size) const {
...
Tensor & CPUIntType::ones_out(Tensor & result, IntList size) const {
    auto result_ = checked_cast_tensor<CPUIntTensor>(result.pImpl,"result",0, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THIntTensor_ones(result_->tensor, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPUIntType::ones(IntList size) const {
    auto result_ = new CPUIntTensor(context);
    auto result = Tensor(result_, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THIntTensor_ones(result_->tensor, size_);
...
Tensor & CPUIntType::index_copy_(Tensor & self, int64_t dim, const Tensor & index, const Tensor & source) const {
    auto self_ = checked_cast_tensor<CPUIntTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
    auto index_ = checked_cast_tensor<CPULongTensor>(index.pImpl,"index",3, false);
...
Tensor & CPUIntType::range_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    auto result_ = checked_cast_tensor<CPUIntTensor>(result.pImpl,"result",0, false);
...
Tensor CPUIntType::range(Scalar start, Scalar end, Scalar step) const {
    auto result_ = new CPUIntTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
...
Tensor & CPUIntType::arange_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    auto result_ = checked_cast_tensor<CPUIntTensor>(result.pImpl,"result",0, false);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
    auto step_ = step.toLong();
...
Tensor CPUIntType::arange(Scalar start, Scalar end, Scalar step) const {
    auto result_ = new CPUIntTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toLong();
    auto end_ = end.toLong();
...
Tensor & CPUIntType::arange_out(Tensor & result, Scalar end) const {
    auto result_ = checked_cast_tensor<CPUIntTensor>(result.pImpl,"result",0, false);
    auto end_ = end.toLong();
    THIntTensor_arange(result_->tensor, 0, end_, 1);
    return result;
}
Tensor CPUIntType::arange(Scalar end) const {
    auto result_ = new CPUIntTensor(context);
    auto result = Tensor(result_, false);
    auto end_ = end.toLong();
    THIntTensor_arange(result_->tensor, 0, end_, 1);
...
Tensor CPUIntType::abs(const Tensor & self) const {
    auto result_ = new CPUIntTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUIntTensor>(self.pImpl,"self",1, false);
    THIntTensor_abs(result_->tensor, self_->tensor);
...
Tensor & CPUIntType::abs_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUIntTensor>(self.pImpl,"self",1, false);
    THIntTensor_abs(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUIntType::sum(const Tensor & self, int64_t dim, bool keepdim) const {
    auto result_ = new CPUIntTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUIntTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor CPUIntType::prod(const Tensor & self, int64_t dim, bool keepdim) const {
    auto result_ = new CPUIntTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUIntTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor & CPUIntType::eye_out(Tensor & result, int64_t n, int64_t m) const {
    auto result_ = checked_cast_tensor<CPUIntTensor>(result.pImpl,"result",0, false);
    THIntTensor_eye(result_->tensor, n, m);
    return result;
}
Tensor CPUIntType::eye(int64_t n, int64_t m) const {
    auto result_ = new CPUIntTensor(context);
    auto result = Tensor(result_, false);
    THIntTensor_eye(result_->tensor, n, m);
    return result;
...
Tensor & CPUIntType::randperm_out(Tensor & result, int64_t n, Generator * generator) const {
    ...
    THIntTensor_randperm(result_->tensor, generator_->generator, n);
    return result;
}
Tensor CPUIntType::randperm(int64_t n, Generator * generator) const {
    auto result_ = new CPUIntTensor(context);
    auto result = Tensor(result_, false);
    auto generator_ = check_generator<CPUGenerator>(generator, &context->defaultGenerator(backend()));
    THIntTensor_randperm(result_->tensor, generator_->generator, n);
...
Tensor & CPUIntType::reshape_(Tensor & self, IntList size, IntList stride) const {
    auto self_ = checked_cast_tensor<CPUIntTensor>(self.pImpl,"self",1, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    auto stride_ = THLongStorageView::makeFromStride(stride, is_noelem_tensor_size(size));
    THIntTensor_resize(self_->tensor, size_, stride_);
    self_->maybeScalar(size.size() == 0);
    return self;
}
