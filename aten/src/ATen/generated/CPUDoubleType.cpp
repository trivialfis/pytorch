...
Tensor & CPUDoubleType::zeros_out(Tensor & result, IntList size) const {
    auto result_ = checked_cast_tensor<CPUDoubleTensor>(result.pImpl,"result",0, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THDoubleTensor_zeros(result_->tensor, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPUDoubleType::zeros(IntList size) const {
...
Tensor & CPUDoubleType::ones_out(Tensor & result, IntList size) const {
    auto result_ = checked_cast_tensor<CPUDoubleTensor>(result.pImpl,"result",0, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THDoubleTensor_ones(result_->tensor, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPUDoubleType::ones(IntList size) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    THDoubleTensor_ones(result_->tensor, size_);
...
Tensor & CPUDoubleType::fill_(Tensor & self, const Tensor & value) const {
    ...
    runtime_error("fill_ only supports a 0-dimensional value tensor, but got tensor "
...
Tensor & CPUDoubleType::s_masked_fill_(Tensor & self, const Tensor & mask, const Tensor & value) const {
    ...
    runtime_error("masked_fill_ only supports a 0-dimensional value tensor, but got tensor "
        "with %" PRId64 " dimension(s)", value.dim());
}
...
Tensor & CPUDoubleType::index_copy_(Tensor & self, int64_t dim, const Tensor & index, const Tensor & source) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
    auto index_ = checked_cast_tensor<CPULongTensor>(index.pImpl,"index",3, false);
...
Tensor & CPUDoubleType::index_fill_(Tensor & self, int64_t dim, const Tensor & index, const Tensor & value) const {
    ...
    runtime_error("index_fill_ only supports a 0-dimensional value tensor, but got tensor "
        "with %" PRId64 " dimension(s)", value.dim());
}
...
Tensor & CPUDoubleType::range_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    auto result_ = checked_cast_tensor<CPUDoubleTensor>(result.pImpl,"result",0, false);
...
Tensor CPUDoubleType::range(Scalar start, Scalar end, Scalar step) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toDouble();
    auto end_ = end.toDouble();
...
Tensor & CPUDoubleType::arange_out(Tensor & result, Scalar start, Scalar end, Scalar step) const {
    auto result_ = checked_cast_tensor<CPUDoubleTensor>(result.pImpl,"result",0, false);
    auto start_ = start.toDouble();
    auto end_ = end.toDouble();
    auto step_ = step.toDouble();
...
Tensor CPUDoubleType::arange(Scalar start, Scalar end, Scalar step) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toDouble();
    auto end_ = end.toDouble();
...
Tensor & CPUDoubleType::arange_out(Tensor & result, Scalar end) const {
    auto result_ = checked_cast_tensor<CPUDoubleTensor>(result.pImpl,"result",0, false);
    auto end_ = end.toDouble();
    THDoubleTensor_arange(result_->tensor, 0, end_, 1);
    return result;
}
Tensor CPUDoubleType::arange(Scalar end) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto end_ = end.toDouble();
    THDoubleTensor_arange(result_->tensor, 0, end_, 1);
...
Tensor CPUDoubleType::abs(const Tensor & self) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_abs(result_->tensor, self_->tensor);
...
Tensor & CPUDoubleType::abs_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_abs(self_->tensor, self_->tensor);
    return self;
}
...
Tensor & CPUDoubleType::log_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_log(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUDoubleType::log(const Tensor & self) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_log(result_->tensor, self_->tensor);
...
Tensor & CPUDoubleType::exp_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_exp(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUDoubleType::exp(const Tensor & self) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_exp(result_->tensor, self_->tensor);
...
Tensor & CPUDoubleType::cos_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_cos(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUDoubleType::cos(const Tensor & self) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_cos(result_->tensor, self_->tensor);
...
Tensor & CPUDoubleType::sin_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_sin(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUDoubleType::sin(const Tensor & self) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_sin(result_->tensor, self_->tensor);
...
Tensor & CPUDoubleType::sqrt_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_sqrt(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUDoubleType::sqrt(const Tensor & self) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_sqrt(result_->tensor, self_->tensor);
...
Tensor & CPUDoubleType::ceil_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_ceil(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUDoubleType::ceil(const Tensor & self) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_ceil(result_->tensor, self_->tensor);
...
Tensor & CPUDoubleType::floor_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_floor(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUDoubleType::floor(const Tensor & self) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_floor(result_->tensor, self_->tensor);
...
Tensor & CPUDoubleType::round_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_round(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUDoubleType::round(const Tensor & self) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_round(result_->tensor, self_->tensor);
...
Tensor & CPUDoubleType::trunc_(Tensor & self) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_trunc(self_->tensor, self_->tensor);
    return self;
}
...
Tensor CPUDoubleType::trunc(const Tensor & self) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    THDoubleTensor_trunc(result_->tensor, self_->tensor);
...
Tensor CPUDoubleType::linspace(Scalar start, Scalar end, int64_t steps) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toDouble();
    auto end_ = end.toDouble();
...
Tensor & CPUDoubleType::logspace_out(Tensor & result, Scalar start, Scalar end, int64_t steps) const {
    auto result_ = checked_cast_tensor<CPUDoubleTensor>(result.pImpl,"result",0, false);
    auto start_ = start.toDouble();
    auto end_ = end.toDouble();
...
Tensor CPUDoubleType::logspace(Scalar start, Scalar end, int64_t steps) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto start_ = start.toDouble();
    auto end_ = end.toDouble();
...
Tensor CPUDoubleType::sum(const Tensor & self, int64_t dim, bool keepdim) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor CPUDoubleType::prod(const Tensor & self, int64_t dim, bool keepdim) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    dim = maybe_wrap_dim(dim, self_);
...
Tensor & CPUDoubleType::eye_out(Tensor & result, int64_t n, int64_t m) const {
    auto result_ = checked_cast_tensor<CPUDoubleTensor>(result.pImpl,"result",0, false);
    THDoubleTensor_eye(result_->tensor, n, m);
    return result;
}
Tensor CPUDoubleType::eye(int64_t n, int64_t m) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    THDoubleTensor_eye(result_->tensor, n, m);
    return result;
...
Tensor & CPUDoubleType::randperm_out(Tensor & result, int64_t n, Generator * generator) const {
    ...
    THDoubleTensor_randperm(result_->tensor, generator_->generator, n);
    return result;
}
Tensor CPUDoubleType::randperm(int64_t n, Generator * generator) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto generator_ = check_generator<CPUGenerator>(generator, &context->defaultGenerator(backend()));
    THDoubleTensor_randperm(result_->tensor, generator_->generator, n);
...
Tensor & CPUDoubleType::rand_out(Tensor & result, IntList size, Generator * generator) const {
    auto result_ = checked_cast_tensor<CPUDoubleTensor>(result.pImpl,"result",0, false);
    auto generator_ = check_generator<CPUGenerator>(generator, &context->defaultGenerator(backend()));
    auto size_ = THLongStorageView::makeFromSize(size);
    THDoubleTensor_rand(result_->tensor, generator_->generator, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPUDoubleType::rand(IntList size, Generator * generator) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto generator_ = check_generator<CPUGenerator>(generator, &context->defaultGenerator(backend()));
    auto size_ = THLongStorageView::makeFromSize(size);
...
Tensor & CPUDoubleType::randn_out(Tensor & result, IntList size, Generator * generator) const {
    auto result_ = checked_cast_tensor<CPUDoubleTensor>(result.pImpl,"result",0, false);
    auto generator_ = check_generator<CPUGenerator>(generator, &context->defaultGenerator(backend()));
    auto size_ = THLongStorageView::makeFromSize(size);
    THDoubleTensor_randn(result_->tensor, generator_->generator, size_);
    result_->maybeScalar(size.size() == 0);
    return result;
}
Tensor CPUDoubleType::randn(IntList size, Generator * generator) const {
    auto result_ = new CPUDoubleTensor(context);
    auto result = Tensor(result_, false);
    auto generator_ = check_generator<CPUGenerator>(generator, &context->defaultGenerator(backend()));
    auto size_ = THLongStorageView::makeFromSize(size);
...
Tensor & CPUDoubleType::_cat_out(Tensor & self, TensorList tensors, int64_t dim) const {
    ...
    dim = maybe_wrap_dim(dim, tensors);
...
Tensor & CPUDoubleType::reshape_(Tensor & self, IntList size, IntList stride) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    auto size_ = THLongStorageView::makeFromSize(size);
    auto stride_ = THLongStorageView::makeFromStride(stride, is_noelem_tensor_size(size));
    THDoubleTensor_resize(self_->tensor, size_, stride_);
    self_->maybeScalar(size.size() == 0);
    return self;
}
...
Tensor & CPUDoubleType::upsample_linear1d_forward_out(Tensor & output, const Tensor & self, IntList output_size) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    auto output_size_ = check_intlist<1>(output_size, "output_size", 2);
    auto output_ = checked_cast_tensor<CPUDoubleTensor>(output.pImpl,"output",2, false);
    THNN_DoubleTemporalUpSamplingLinear_updateOutput(context->thc_state, self_->tensor, output_->tensor, output_size_[0]);
    return output;
}
Tensor CPUDoubleType::upsample_linear1d_forward(const Tensor & self, IntList output_size) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    auto output_size_ = check_intlist<1>(output_size, "output_size", 2);
    auto output_ = new CPUDoubleTensor(context);
    auto output = Tensor(output_, false);
...
Tensor & CPUDoubleType::upsample_linear1d_backward_out(Tensor & grad_input, const Tensor & grad_output, IntList output_size, IntList input_size) const {
    auto grad_output_ = checked_cast_tensor<CPUDoubleTensor>(grad_output.pImpl,"grad_output",1, false);
    auto output_size_ = check_intlist<1>(output_size, "output_size", 2);
    auto grad_input_ = checked_cast_tensor<CPUDoubleTensor>(grad_input.pImpl,"grad_input",2, false);
    auto input_size_ = check_intlist<3>(input_size, "input_size", 3);
    THNN_DoubleTemporalUpSamplingLinear_updateGradInput(context->thc_state, grad_output_->tensor, grad_input_->tensor, input_size_[0], input_size_[1], input_size_[2], output_size_[0]);
    grad_input_->maybeScalar(false);
    return grad_input;
}
Tensor CPUDoubleType::upsample_linear1d_backward(const Tensor & grad_output, IntList output_size, IntList input_size) const {
    auto grad_output_ = checked_cast_tensor<CPUDoubleTensor>(grad_output.pImpl,"grad_output",1, false);
    auto output_size_ = check_intlist<1>(output_size, "output_size", 2);
    auto grad_input_ = new CPUDoubleTensor(context);
    auto grad_input = Tensor(grad_input_, false);
...
Tensor & CPUDoubleType::upsample_bilinear2d_forward_out(Tensor & output, const Tensor & self, IntList output_size) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    auto output_size_ = check_intlist<2>(output_size, "output_size", 2);
    auto output_ = checked_cast_tensor<CPUDoubleTensor>(output.pImpl,"output",2, false);
    THNN_DoubleSpatialUpSamplingBilinear_updateOutput(context->thc_state, self_->tensor, output_->tensor, output_size_[0], output_size_[1]);
    return output;
}
Tensor CPUDoubleType::upsample_bilinear2d_forward(const Tensor & self, IntList output_size) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    auto output_size_ = check_intlist<2>(output_size, "output_size", 2);
    auto output_ = new CPUDoubleTensor(context);
    auto output = Tensor(output_, false);
...
Tensor & CPUDoubleType::upsample_bilinear2d_backward_out(Tensor & grad_input, const Tensor & grad_output, IntList output_size, IntList input_size) const {
    auto grad_output_ = checked_cast_tensor<CPUDoubleTensor>(grad_output.pImpl,"grad_output",1, false);
    auto output_size_ = check_intlist<2>(output_size, "output_size", 2);
    auto grad_input_ = checked_cast_tensor<CPUDoubleTensor>(grad_input.pImpl,"grad_input",2, false);
    auto input_size_ = check_intlist<4>(input_size, "input_size", 3);
    THNN_DoubleSpatialUpSamplingBilinear_updateGradInput(context->thc_state, grad_output_->tensor, grad_input_->tensor, input_size_[0], input_size_[1], input_size_[2], input_size_[3], output_size_[0], output_size_[1]);
    grad_input_->maybeScalar(false);
    return grad_input;
}
Tensor CPUDoubleType::upsample_bilinear2d_backward(const Tensor & grad_output, IntList output_size, IntList input_size) const {
    auto grad_output_ = checked_cast_tensor<CPUDoubleTensor>(grad_output.pImpl,"grad_output",1, false);
    auto output_size_ = check_intlist<2>(output_size, "output_size", 2);
    auto grad_input_ = new CPUDoubleTensor(context);
    auto grad_input = Tensor(grad_input_, false);
...
Tensor & CPUDoubleType::upsample_trilinear3d_forward_out(Tensor & output, const Tensor & self, IntList output_size) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    auto output_size_ = check_intlist<3>(output_size, "output_size", 2);
    auto output_ = checked_cast_tensor<CPUDoubleTensor>(output.pImpl,"output",2, false);
    THNN_DoubleVolumetricUpSamplingTrilinear_updateOutput(context->thc_state, self_->tensor, output_->tensor, output_size_[0], output_size_[1], output_size_[2]);
    return output;
}
Tensor CPUDoubleType::upsample_trilinear3d_forward(const Tensor & self, IntList output_size) const {
    auto self_ = checked_cast_tensor<CPUDoubleTensor>(self.pImpl,"self",1, false);
    auto output_size_ = check_intlist<3>(output_size, "output_size", 2);
    auto output_ = new CPUDoubleTensor(context);
    auto output = Tensor(output_, false);
...
Tensor & CPUDoubleType::upsample_trilinear3d_backward_out(Tensor & grad_input, const Tensor & grad_output, IntList output_size, IntList input_size) const {
    auto grad_output_ = checked_cast_tensor<CPUDoubleTensor>(grad_output.pImpl,"grad_output",1, false);
    auto output_size_ = check_intlist<3>(output_size, "output_size", 2);
    auto grad_input_ = checked_cast_tensor<CPUDoubleTensor>(grad_input.pImpl,"grad_input",2, false);
    auto input_size_ = check_intlist<5>(input_size, "input_size", 3);
    THNN_DoubleVolumetricUpSamplingTrilinear_updateGradInput(context->thc_state, grad_output_->tensor, grad_input_->tensor, input_size_[0], input_size_[1], input_size_[2], input_size_[3], input_size_[4], output_size_[0], output_size_[1], output_size_[2]);
    grad_input_->maybeScalar(false);
    return grad_input;
}
Tensor CPUDoubleType::upsample_trilinear3d_backward(const Tensor & grad_output, IntList output_size, IntList input_size) const {
    auto grad_output_ = checked_cast_tensor<CPUDoubleTensor>(grad_output.pImpl,"grad_output",1, false);
    auto output_size_ = check_intlist<3>(output_size, "output_size", 2);
    auto grad_input_ = new CPUDoubleTensor(context);
    auto grad_input = Tensor(grad_input_, false);
