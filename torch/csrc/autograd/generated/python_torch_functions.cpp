...
static PyObject * THPVariable__cudnn_init_dropout_state(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "_cudnn_init_dropout_state(Type ty, double dropout, bool train, int64_t dropout_seed, *, Type dtype=None, int64_t device=-1, bool requires_grad=False)",
  });

  ParsedArgs<7> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(set_requires_grad(dispatch__cudnn_init_dropout_state(r.type(0), r.toDouble(1), r.toBool(2), r.toInt64(3), r.type(4), r.toInt64(5)), r.toBool(6)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_arange(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "arange(Scalar end, *, Tensor out=None, Type dtype=None, int64_t device=-1, bool requires_grad=False)",
    "arange(Scalar start, Scalar end, Scalar step=1, *, Tensor out=None, Type dtype=None, int64_t device=-1, bool requires_grad=False)",
  });
  ...
  if (r.idx == 0) {
    if (r.isNone(1)) {
      return wrap(set_requires_grad(dispatch_arange(r.scalar(0), r.type(2), r.toInt64(3)), r.toBool(4)));
    } else {
      if (!r.isNone(2)) {
        check_out_dtype_matches(r.tensor(1), r.type(2));
      }
      return wrap(set_requires_grad(dispatch_arange(r.scalar(0), r.tensor(1)), r.toBool(4)));
    }
  } else if (r.idx == 1) {
    if (r.isNone(3)) {
      return wrap(set_requires_grad(dispatch_arange(r.scalar(0), r.scalar(1), r.scalar(2), r.type(4), r.toInt64(5)), r.toBool(6)));
    } else {
      if (!r.isNone(4)) {
        check_out_dtype_matches(r.tensor(3), r.type(4));
      }
      return wrap(set_requires_grad(dispatch_arange(r.scalar(0), r.scalar(1), r.scalar(2), r.tensor(3)), r.toBool(6)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_empty_like(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "empty_like(Tensor input, *, Type dtype, int64_t device=-1, bool requires_grad=False)",
    "empty_like(Tensor input, *, int64_t device=-1, bool requires_grad=False)",
  });

  ParsedArgs<4> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(set_requires_grad(dispatch_empty_like(r.tensor(0), r.type(1), r.toInt64(2)), r.toBool(3)));
  } else if (r.idx == 1) {
    return wrap(set_requires_grad(dispatch_empty_like(r.tensor(0), r.toInt64(1)), r.toBool(2)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_eye(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "eye(int64_t n, int64_t m=-1, *, Tensor out=None, Type dtype=None, int64_t device=-1, bool requires_grad=False)",
  });
  ...
  if (r.idx == 0) {
    if (r.isNone(2)) {
      return wrap(set_requires_grad(dispatch_eye(r.toInt64(0), r.toInt64(1), r.type(3), r.toInt64(4)), r.toBool(5)));
    } else {
      if (!r.isNone(3)) {
        check_out_dtype_matches(r.tensor(2), r.type(3));
      }
      return wrap(set_requires_grad(dispatch_eye(r.toInt64(0), r.toInt64(1), r.tensor(2)), r.toBool(5)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_linspace(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "linspace(Scalar start, Scalar end, int64_t steps=100, *, Tensor out=None, Type dtype=None, int64_t device=-1, bool requires_grad=False)",
  });
  ...
  if (r.idx == 0) {
    if (r.isNone(3)) {
      return wrap(set_requires_grad(dispatch_linspace(r.scalar(0), r.scalar(1), r.toInt64(2), r.type(4), r.toInt64(5)), r.toBool(6)));
    } else {
      if (!r.isNone(4)) {
        check_out_dtype_matches(r.tensor(3), r.type(4));
      }
      return wrap(set_requires_grad(dispatch_linspace(r.scalar(0), r.scalar(1), r.toInt64(2), r.tensor(3)), r.toBool(6)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_logspace(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "logspace(Scalar start, Scalar end, int64_t steps=100, *, Tensor out=None, Type dtype=None, int64_t device=-1, bool requires_grad=False)",
  });
  ...
  if (r.idx == 0) {
    if (r.isNone(3)) {
      return wrap(set_requires_grad(dispatch_logspace(r.scalar(0), r.scalar(1), r.toInt64(2), r.type(4), r.toInt64(5)), r.toBool(6)));
    } else {
      if (!r.isNone(4)) {
        check_out_dtype_matches(r.tensor(3), r.type(4));
      }
      return wrap(set_requires_grad(dispatch_logspace(r.scalar(0), r.scalar(1), r.toInt64(2), r.tensor(3)), r.toBool(6)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_ones(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "ones(IntList size, *, Tensor out=None, Type dtype=None, int64_t device=-1, bool requires_grad=False)",
  });
  ...
  if (r.idx == 0) {
    if (r.isNone(1)) {
      return wrap(set_requires_grad(dispatch_ones(r.intlist(0), r.type(2), r.toInt64(3)), r.toBool(4)));
    } else {
      if (!r.isNone(2)) {
        check_out_dtype_matches(r.tensor(1), r.type(2));
      }
      return wrap(set_requires_grad(dispatch_ones(r.intlist(0), r.tensor(1)), r.toBool(4)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_ones_like(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "ones_like(Tensor input, *, Type dtype, int64_t device=-1, bool requires_grad=False)",
    "ones_like(Tensor input, *, int64_t device=-1, bool requires_grad=False)",
  });

  ParsedArgs<4> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(set_requires_grad(dispatch_ones_like(r.tensor(0), r.type(1), r.toInt64(2)), r.toBool(3)));
  } else if (r.idx == 1) {
    return wrap(set_requires_grad(dispatch_ones_like(r.tensor(0), r.toInt64(1)), r.toBool(2)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_rand(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "rand(IntList size, *, Generator generator=None, Tensor out=None, Type dtype=None, int64_t device=-1, bool requires_grad=False)",
  });
  ...
  if (r.idx == 0) {
    if (r.isNone(2)) {
      return wrap(set_requires_grad(dispatch_rand(r.intlist(0), r.generator(1), r.type(3), r.toInt64(4)), r.toBool(5)));
    } else {
      if (!r.isNone(3)) {
        check_out_dtype_matches(r.tensor(2), r.type(3));
      }
      return wrap(set_requires_grad(dispatch_rand(r.intlist(0), r.generator(1), r.tensor(2)), r.toBool(5)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_rand_like(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "rand_like(Tensor input, *, Type dtype, int64_t device=-1, bool requires_grad=False)",
    "rand_like(Tensor input, *, int64_t device=-1, bool requires_grad=False)",
  });

  ParsedArgs<4> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(set_requires_grad(dispatch_rand_like(r.tensor(0), r.type(1), r.toInt64(2)), r.toBool(3)));
  } else if (r.idx == 1) {
    return wrap(set_requires_grad(dispatch_rand_like(r.tensor(0), r.toInt64(1)), r.toBool(2)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_randn(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "randn(IntList size, *, Generator generator=None, Tensor out=None, Type dtype=None, int64_t device=-1, bool requires_grad=False)",
  });
  ...
  if (r.idx == 0) {
    if (r.isNone(2)) {
      return wrap(set_requires_grad(dispatch_randn(r.intlist(0), r.generator(1), r.type(3), r.toInt64(4)), r.toBool(5)));
    } else {
      if (!r.isNone(3)) {
        check_out_dtype_matches(r.tensor(2), r.type(3));
      }
      return wrap(set_requires_grad(dispatch_randn(r.intlist(0), r.generator(1), r.tensor(2)), r.toBool(5)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_randn_like(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "randn_like(Tensor input, *, Type dtype, int64_t device=-1, bool requires_grad=False)",
    "randn_like(Tensor input, *, int64_t device=-1, bool requires_grad=False)",
  });

  ParsedArgs<4> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(set_requires_grad(dispatch_randn_like(r.tensor(0), r.type(1), r.toInt64(2)), r.toBool(3)));
  } else if (r.idx == 1) {
    return wrap(set_requires_grad(dispatch_randn_like(r.tensor(0), r.toInt64(1)), r.toBool(2)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
static PyObject * THPVariable_randperm(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "randperm(int64_t n, *, Generator generator=None, Tensor out=None, Type dtype=torch.int64, int64_t device=-1, bool requires_grad=False)",
  });
  ...
  if (r.idx == 0) {
    if (r.isNone(2)) {
      return wrap(set_requires_grad(dispatch_randperm(r.toInt64(0), r.generator(1), r.type(3), r.toInt64(4)), r.toBool(5)));
    } else {
      if (!r.isNone(3)) {
        check_out_dtype_matches(r.tensor(2), r.type(3));
      }
      return wrap(set_requires_grad(dispatch_randperm(r.toInt64(0), r.generator(1), r.tensor(2)), r.toBool(5)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_range(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "range(Scalar start, Scalar end, Scalar step=1, *, Tensor out=None, Type dtype=None, int64_t device=-1, bool requires_grad=False)",
  });
  ...
  if (r.idx == 0) {
    if (r.isNone(3)) {
      return wrap(set_requires_grad(dispatch_range(r.scalar(0), r.scalar(1), r.scalar(2), r.type(4), r.toInt64(5)), r.toBool(6)));
    } else {
      if (!r.isNone(4)) {
        check_out_dtype_matches(r.tensor(3), r.type(4));
      }
      return wrap(set_requires_grad(dispatch_range(r.scalar(0), r.scalar(1), r.scalar(2), r.tensor(3)), r.toBool(6)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_zeros(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "zeros(IntList size, *, Tensor out=None, Type dtype=None, int64_t device=-1, bool requires_grad=False)",
  });
  ...
  if (r.idx == 0) {
    if (r.isNone(1)) {
      return wrap(set_requires_grad(dispatch_zeros(r.intlist(0), r.type(2), r.toInt64(3)), r.toBool(4)));
    } else {
      if (!r.isNone(2)) {
        check_out_dtype_matches(r.tensor(1), r.type(2));
      }
      return wrap(set_requires_grad(dispatch_zeros(r.intlist(0), r.tensor(1)), r.toBool(4)));
    }
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
...
static PyObject * THPVariable_zeros_like(PyObject* self, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "zeros_like(Tensor input, *, Type dtype, int64_t device=-1, bool requires_grad=False)",
    "zeros_like(Tensor input, *, int64_t device=-1, bool requires_grad=False)",
  });

  ParsedArgs<4> parsed_args;
  auto r = parser.parse(args, kwargs, parsed_args);
  if (r.idx == 0) {
    return wrap(set_requires_grad(dispatch_zeros_like(r.tensor(0), r.type(1), r.toInt64(2)), r.toBool(3)));
  } else if (r.idx == 1) {
    return wrap(set_requires_grad(dispatch_zeros_like(r.tensor(0), r.toInt64(1)), r.toBool(2)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
