...
ConstructorsMap constructors = {
  ...
  {"_det_with_svd-1", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::_det_with_svd(std::move(peek(stack, 0, 1)));
      drop(stack, 1);
      pack(stack, std::move(result));
      return 0;
    }, "_det_with_svd", 1);
  ...
  {"adaptive_avg_pool1d-2", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("adaptive_avg_pool1d");
      AutoGPU device_guard(deviceForInputs(stack, 2));
      auto output_size = tensor_as<IntList>(std::move(peek(stack, 1, 2)));
  ...
  {"all-1", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = (std::move(peek(stack, 0, 1))).all();
      drop(stack, 1);
      pack(stack, std::move(result));
      return 0;
    }, "all", 1);
  ...
  {"allclose-2-atol-rtol", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::allclose(std::move(peek(stack, 0, 2)), std::move(peek(stack, 1, 2)), rtol, atol);
      drop(stack, 2);
      pack(stack, std::move(result));
      return 0;
    }, "allclose", 2);
  ...
  {"allclose-4", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("allclose");
      AutoGPU device_guard(deviceForInputs(stack, 4));
      auto rtol = tensor_as<double>(std::move(peek(stack, 2, 4)));
      auto atol = tensor_as<double>(std::move(peek(stack, 3, 4)));
      auto result = at::allclose(std::move(peek(stack, 0, 4)), std::move(peek(stack, 1, 4)), rtol, atol);
      drop(stack, 4);
      pack(stack, std::move(result));
      return 0;
    }, "allclose", 4);
  ...
  {"any-1", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = (std::move(peek(stack, 0, 1))).any();
      drop(stack, 1);
      pack(stack, std::move(result));
      return 0;
    }, "any", 1);
  ...
  {"avg_pool2d-6", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("avg_pool2d");
      AutoGPU device_guard(deviceForInputs(stack, 6));
      auto kernel_size = tensor_as<IntList>(std::move(peek(stack, 1, 6)));
      auto stride = tensor_as<IntList>(std::move(peek(stack, 2, 6)));
  ...
  {"avg_pool2d_backward-7", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("avg_pool2d_backward");
      AutoGPU device_guard(deviceForInputs(stack, 7));
      auto kernel_size = tensor_as<IntList>(std::move(peek(stack, 2, 7)));
      auto stride = tensor_as<IntList>(std::move(peek(stack, 3, 7)));
      auto padding = tensor_as<IntList>(std::move(peek(stack, 4, 7)));
  ...
  {"conv_transpose1d-8", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto stride = tensor_as<IntList>(std::move(peek(stack, 3, 8)));
      auto padding = tensor_as<IntList>(std::move(peek(stack, 4, 8)));
      auto output_padding = tensor_as<IntList>(std::move(peek(stack, 5, 8)));
      auto groups = tensor_as<int64_t>(std::move(peek(stack, 6, 8)));
      auto dilation = tensor_as<IntList>(std::move(peek(stack, 7, 8)));
  ...
  {"embedding_bag_backward-5-mode-num_weights-scale_grad_by_freq-sparse", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::embedding_bag_backward(std::move(peek(stack, 0, 5)), std::move(peek(stack, 1, 5)), std::move(peek(stack, 2, 5)), std::move(peek(stack, 3, 5)), std::move(peek(stack, 4, 5)), num_weights, scale_grad_by_freq, mode, sparse);
      drop(stack, 5);
      pack(stack, std::move(result));
      return 0;
  ...
  {"embedding_bag_backward-9", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("embedding_bag_backward");
      AutoGPU device_guard(deviceForInputs(stack, 9));
      auto num_weights = tensor_as<int64_t>(std::move(peek(stack, 5, 9)));
      auto scale_grad_by_freq = tensor_as<bool>(std::move(peek(stack, 6, 9)));
      auto mode = tensor_as<int64_t>(std::move(peek(stack, 7, 9)));
      auto sparse = tensor_as<bool>(std::move(peek(stack, 8, 9)));
      auto result = at::embedding_bag_backward(std::move(peek(stack, 0, 9)), std::move(peek(stack, 1, 9)), std::move(peek(stack, 2, 9)), std::move(peek(stack, 3, 9)), std::move(peek(stack, 4, 9)), num_weights, scale_grad_by_freq, mode, sparse);
      drop(stack, 9);
      pack(stack, std::move(result));
      return 0;
  ...
  {"embedding_bag_dense_backward-5-mode-num_weights-scale_grad_by_freq", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::embedding_bag_dense_backward(std::move(peek(stack, 0, 5)), std::move(peek(stack, 1, 5)), std::move(peek(stack, 2, 5)), std::move(peek(stack, 3, 5)), std::move(peek(stack, 4, 5)), num_weights, scale_grad_by_freq, mode);
      drop(stack, 5);
      pack(stack, std::move(result));
      return 0;
  ...
  {"embedding_bag_dense_backward-8", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::embedding_bag_dense_backward(std::move(peek(stack, 0, 8)), std::move(peek(stack, 1, 8)), std::move(peek(stack, 2, 8)), std::move(peek(stack, 3, 8)), std::move(peek(stack, 4, 8)), num_weights, scale_grad_by_freq, mode);
      drop(stack, 8);
      pack(stack, std::move(result));
      return 0;
  ...
  {"expand-1-size", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = (std::move(peek(stack, 0, 1))).expand(size);
      drop(stack, 1);
      pack(stack, std::move(result));
      return 0;
    }, "expand", 1);
  ...
  {"expand-2", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      AutoGPU device_guard(deviceForInputs(stack, 2));
      auto size = tensor_as<IntList>(std::move(peek(stack, 1, 2)));
      auto result = (std::move(peek(stack, 0, 2))).expand(size);
      drop(stack, 2);
      pack(stack, std::move(result));
      return 0;
    }, "expand", 2);
  ...
  {"fractional_max_pool2d-4", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("fractional_max_pool2d");
      AutoGPU device_guard(deviceForInputs(stack, 4));
      auto kernel_size = tensor_as<IntList>(std::move(peek(stack, 1, 4)));
      auto output_size = tensor_as<IntList>(std::move(peek(stack, 2, 4)));
  ...
  {"fractional_max_pool2d_backward-5", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("fractional_max_pool2d_backward");
      AutoGPU device_guard(deviceForInputs(stack, 5));
      auto kernel_size = tensor_as<IntList>(std::move(peek(stack, 2, 5)));
      auto output_size = tensor_as<IntList>(std::move(peek(stack, 3, 5)));
  ...
  {"log_softmax_backward-3-dim", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::log_softmax_backward(std::move(peek(stack, 0, 3)), std::move(peek(stack, 1, 3)), dim, std::move(peek(stack, 2, 3)));
      drop(stack, 3);
      pack(stack, std::move(result));
      return 0;
  ...
  {"log_softmax_backward-4", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      AutoGPU device_guard(deviceForInputs(stack, 4));
      auto dim = tensor_as<int64_t>(std::move(peek(stack, 2, 4)));
      auto result = at::log_softmax_backward(std::move(peek(stack, 0, 4)), std::move(peek(stack, 1, 4)), dim, std::move(peek(stack, 3, 4)));
      drop(stack, 4);
      pack(stack, std::move(result));
      return 0;
  ...
  {"log_softmax_forward-1-dim", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::log_softmax_forward(std::move(peek(stack, 0, 1)), dim);
      drop(stack, 1);
      pack(stack, std::move(result));
      return 0;
  ...
  {"log_softmax_forward-2", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      AutoGPU device_guard(deviceForInputs(stack, 2));
      auto dim = tensor_as<int64_t>(std::move(peek(stack, 1, 2)));
      auto result = at::log_softmax_forward(std::move(peek(stack, 0, 2)), dim);
      drop(stack, 2);
      pack(stack, std::move(result));
      return 0;
  ...
  {"max_pool1d-6", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto stride = tensor_as<IntList>(std::move(peek(stack, 2, 6)));
      auto padding = tensor_as<IntList>(std::move(peek(stack, 3, 6)));
      auto dilation = tensor_as<IntList>(std::move(peek(stack, 4, 6)));
  ...
  {"max_pool2d_backward-8", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("max_pool2d_backward");
      AutoGPU device_guard(deviceForInputs(stack, 8));
      auto kernel_size = tensor_as<IntList>(std::move(peek(stack, 2, 8)));
      auto stride = tensor_as<IntList>(std::move(peek(stack, 3, 8)));
      auto padding = tensor_as<IntList>(std::move(peek(stack, 4, 8)));
      auto dilation = tensor_as<IntList>(std::move(peek(stack, 5, 8)));
  ...
  {"max_unpool2d-3", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("max_unpool2d");
      AutoGPU device_guard(deviceForInputs(stack, 3));
      auto output_size = tensor_as<IntList>(std::move(peek(stack, 2, 3)));
  ...
  {"max_unpool2d_backward-4", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("max_unpool2d_backward");
      AutoGPU device_guard(deviceForInputs(stack, 4));
      auto output_size = tensor_as<IntList>(std::move(peek(stack, 3, 4)));
  ...
  {"max_unpool3d-5", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("max_unpool3d");
      AutoGPU device_guard(deviceForInputs(stack, 5));
      auto output_size = tensor_as<IntList>(std::move(peek(stack, 2, 5)));
      auto stride = tensor_as<IntList>(std::move(peek(stack, 3, 5)));
      auto padding = tensor_as<IntList>(std::move(peek(stack, 4, 5)));
  ...
  {"max_unpool3d_backward-6", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("max_unpool3d_backward");
      AutoGPU device_guard(deviceForInputs(stack, 6));
      auto output_size = tensor_as<IntList>(std::move(peek(stack, 3, 6)));
      auto stride = tensor_as<IntList>(std::move(peek(stack, 4, 6)));
      auto padding = tensor_as<IntList>(std::move(peek(stack, 5, 6)));
  ...
  {"multi_margin_loss-3-margin-p-reduce-size_average", [](Node *node) {
    auto p = Scalar(node->t(Symbol("p")));
  ...
  {"multi_margin_loss_backward-4-margin-p-reduce-size_average", [](Node *node) {
    auto p = Scalar(node->t(Symbol("p")));
    auto margin = Scalar(node->t(Symbol("margin")));
    auto size_average = bool(node->i(Symbol("size_average")));
    auto reduce = bool(node->i(Symbol("reduce")));
  ...
  {"multi_margin_loss_backward-8", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      pack(stack, std::move(result));
      return 0;
    }, "multi_margin_loss_backward", 8);
  }},
  {"multi_margin_loss_forward-3-margin-p-reduce-size_average", [](Node *node) {
    auto p = Scalar(node->t(Symbol("p")));
    auto margin = Scalar(node->t(Symbol("margin")));
    auto size_average = bool(node->i(Symbol("size_average")));
    auto reduce = bool(node->i(Symbol("reduce")));
  ...
  {"nnpack_spatial_convolution-3-kH-kW-padH-padW", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::nnpack_spatial_convolution(std::move(peek(stack, 0, 3)), std::move(peek(stack, 1, 3)), std::move(peek(stack, 2, 3)), kW, kH, padW, padH);
      drop(stack, 3);
      pack(stack, std::move(result));
      return 0;
  ...
  {"nnpack_spatial_convolution-7", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("nnpack_spatial_convolution");
      AutoGPU device_guard(deviceForInputs(stack, 7));
      auto kW = tensor_as<int64_t>(std::move(peek(stack, 3, 7)));
      auto kH = tensor_as<int64_t>(std::move(peek(stack, 4, 7)));
      auto padW = tensor_as<int64_t>(std::move(peek(stack, 5, 7)));
      auto padH = tensor_as<int64_t>(std::move(peek(stack, 6, 7)));
      auto result = at::nnpack_spatial_convolution(std::move(peek(stack, 0, 7)), std::move(peek(stack, 1, 7)), std::move(peek(stack, 2, 7)), kW, kH, padW, padH);
      drop(stack, 7);
      pack(stack, std::move(result));
      return 0;
  ...
  {"nnpack_spatial_convolution_backward-3-kH-kW-output_mask-padH-padW", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::nnpack_spatial_convolution_backward(std::move(peek(stack, 0, 3)), std::move(peek(stack, 1, 3)), std::move(peek(stack, 2, 3)), kW, kH, padW, padH, output_mask);
      drop(stack, 3);
      pack(stack, std::move(result));
      return 0;
  ...
  {"nnpack_spatial_convolution_backward-8", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("nnpack_spatial_convolution_backward");
      AutoGPU device_guard(deviceForInputs(stack, 8));
      auto kW = tensor_as<int64_t>(std::move(peek(stack, 3, 8)));
      auto kH = tensor_as<int64_t>(std::move(peek(stack, 4, 8)));
      auto padW = tensor_as<int64_t>(std::move(peek(stack, 5, 8)));
      auto padH = tensor_as<int64_t>(std::move(peek(stack, 6, 8)));
      auto output_mask = tensor_as<std::array<bool,3>>(std::move(peek(stack, 7, 8)));
      auto result = at::nnpack_spatial_convolution_backward(std::move(peek(stack, 0, 8)), std::move(peek(stack, 1, 8)), std::move(peek(stack, 2, 8)), kW, kH, padW, padH, output_mask);
      drop(stack, 8);
      pack(stack, std::move(result));
      return 0;
  ...
  {"nnpack_spatial_convolution_backward_input-3-kH-kW-padH-padW", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::nnpack_spatial_convolution_backward_input(std::move(peek(stack, 0, 3)), std::move(peek(stack, 1, 3)), std::move(peek(stack, 2, 3)), kW, kH, padW, padH);
      drop(stack, 3);
      pack(stack, std::move(result));
      return 0;
  ...
  {"nnpack_spatial_convolution_backward_input-7", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto padW = tensor_as<int64_t>(std::move(peek(stack, 5, 7)));
      auto padH = tensor_as<int64_t>(std::move(peek(stack, 6, 7)));
      auto result = at::nnpack_spatial_convolution_backward_input(std::move(peek(stack, 0, 7)), std::move(peek(stack, 1, 7)), std::move(peek(stack, 2, 7)), kW, kH, padW, padH);
      drop(stack, 7);
      pack(stack, std::move(result));
      return 0;
  ...
  {"nnpack_spatial_convolution_backward_weight-2-kH-kW-padH-padW-weight_size", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::nnpack_spatial_convolution_backward_weight(std::move(peek(stack, 0, 2)), weight_size, std::move(peek(stack, 1, 2)), kW, kH, padW, padH);
      drop(stack, 2);
      pack(stack, std::move(result));
      return 0;
  ...
  {"nnpack_spatial_convolution_backward_weight-7", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("nnpack_spatial_convolution_backward_weight");
      AutoGPU device_guard(deviceForInputs(stack, 7));
      auto weight_size = tensor_as<IntList>(std::move(peek(stack, 1, 7)));
      auto kW = tensor_as<int64_t>(std::move(peek(stack, 3, 7)));
      auto kH = tensor_as<int64_t>(std::move(peek(stack, 4, 7)));
      auto padW = tensor_as<int64_t>(std::move(peek(stack, 5, 7)));
      auto padH = tensor_as<int64_t>(std::move(peek(stack, 6, 7)));
      auto result = at::nnpack_spatial_convolution_backward_weight(std::move(peek(stack, 0, 7)), weight_size, std::move(peek(stack, 2, 7)), kW, kH, padW, padH);
      drop(stack, 7);
      pack(stack, std::move(result));
      return 0;
  ...
  {"reflection_pad1d-2", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("reflection_pad1d");
      AutoGPU device_guard(deviceForInputs(stack, 2));
      auto padding = tensor_as<IntList>(std::move(peek(stack, 1, 2)));
  ...
  {"reflection_pad1d_backward-3", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("reflection_pad1d_backward");
      AutoGPU device_guard(deviceForInputs(stack, 3));
      auto padding = tensor_as<IntList>(std::move(peek(stack, 2, 3)));
  ...
  {"softmax_backward-3-dim", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::softmax_backward(std::move(peek(stack, 0, 3)), std::move(peek(stack, 1, 3)), dim, std::move(peek(stack, 2, 3)));
      drop(stack, 3);
      pack(stack, std::move(result));
      return 0;
    }, "softmax_backward", 3);
  ...
  {"softmax_backward-4", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      AutoGPU device_guard(deviceForInputs(stack, 4));
      auto dim = tensor_as<int64_t>(std::move(peek(stack, 2, 4)));
      auto result = at::softmax_backward(std::move(peek(stack, 0, 4)), std::move(peek(stack, 1, 4)), dim, std::move(peek(stack, 3, 4)));
      drop(stack, 4);
      pack(stack, std::move(result));
      return 0;
    }, "softmax_backward", 4);
  ...
  {"softmax_forward-1-dim", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::softmax_forward(std::move(peek(stack, 0, 1)), dim);
      drop(stack, 1);
      pack(stack, std::move(result));
      return 0;
    }, "softmax_forward", 1);
  ...
  {"softmax_forward-2", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      AutoGPU device_guard(deviceForInputs(stack, 2));
      auto dim = tensor_as<int64_t>(std::move(peek(stack, 1, 2)));
      auto result = at::softmax_forward(std::move(peek(stack, 0, 2)), dim);
      drop(stack, 2);
      pack(stack, std::move(result));
      return 0;
    }, "softmax_forward", 2);
  ...
  {"stft-2-fft_size-frame_length-hop-pad_end-return_onesided", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::stft(std::move(peek(stack, 0, 2)), frame_length, hop, fft_size, return_onesided, std::move(peek(stack, 1, 2)), pad_end);
      drop(stack, 2);
      pack(stack, std::move(result));
      return 0;
    }, "stft", 2);
  ...
  {"stft-7", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("stft");
      AutoGPU device_guard(deviceForInputs(stack, 7));
      auto frame_length = tensor_as<int64_t>(std::move(peek(stack, 1, 7)));
      auto hop = tensor_as<int64_t>(std::move(peek(stack, 2, 7)));
      auto fft_size = tensor_as<int64_t>(std::move(peek(stack, 3, 7)));
      auto return_onesided = tensor_as<bool>(std::move(peek(stack, 4, 7)));
      auto pad_end = tensor_as<int64_t>(std::move(peek(stack, 6, 7)));
      auto result = at::stft(std::move(peek(stack, 0, 7)), frame_length, hop, fft_size, return_onesided, std::move(peek(stack, 5, 7)), pad_end);
      drop(stack, 7);
      pack(stack, std::move(result));
      return 0;
    }, "stft", 7);
  ...
  {"thnn_conv2d-6", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("thnn_conv2d");
      AutoGPU device_guard(deviceForInputs(stack, 6));
      auto kernel_size = tensor_as<IntList>(std::move(peek(stack, 2, 6)));
      auto stride = tensor_as<IntList>(std::move(peek(stack, 4, 6)));
      auto padding = tensor_as<IntList>(std::move(peek(stack, 5, 6)));
  ...
  {"thnn_conv2d_backward-9", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("thnn_conv2d_backward");
      AutoGPU device_guard(deviceForInputs(stack, 9));
      auto kernel_size = tensor_as<IntList>(std::move(peek(stack, 3, 9)));
      auto stride = tensor_as<IntList>(std::move(peek(stack, 4, 9)));
      auto padding = tensor_as<IntList>(std::move(peek(stack, 5, 9)));
  ...
  {"thnn_conv_depthwise2d-7", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto padding = tensor_as<IntList>(std::move(peek(stack, 5, 7)));
      auto dilation = tensor_as<IntList>(std::move(peek(stack, 6, 7)));
  ...
  {"thnn_conv_depthwise2d_backward-8", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("thnn_conv_depthwise2d_backward");
      AutoGPU device_guard(deviceForInputs(stack, 8));
      auto kernel_size = tensor_as<IntList>(std::move(peek(stack, 3, 8)));
      auto stride = tensor_as<IntList>(std::move(peek(stack, 4, 8)));
      auto padding = tensor_as<IntList>(std::move(peek(stack, 5, 8)));
      auto dilation = tensor_as<IntList>(std::move(peek(stack, 6, 8)));
  ...
  {"thnn_conv_dilated2d_backward-10", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      AutoGPU device_guard(deviceForInputs(stack, 10));
      auto kernel_size = tensor_as<IntList>(std::move(peek(stack, 3, 10)));
      auto stride = tensor_as<IntList>(std::move(peek(stack, 4, 10)));
      auto padding = tensor_as<IntList>(std::move(peek(stack, 5, 10)));
      auto dilation = tensor_as<IntList>(std::move(peek(stack, 6, 10)));
      auto output_mask = tensor_as<std::array<bool,3>>(std::move(peek(stack, 9, 10)));
  ...
  {"thnn_conv_transpose2d-8", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto stride = tensor_as<IntList>(std::move(peek(stack, 4, 8)));
      auto padding = tensor_as<IntList>(std::move(peek(stack, 5, 8)));
      auto output_padding = tensor_as<IntList>(std::move(peek(stack, 6, 8)));
      auto dilation = tensor_as<IntList>(std::move(peek(stack, 7, 8)));
  ...
  {"thnn_conv_transpose2d_backward-11", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      AutoGPU device_guard(deviceForInputs(stack, 11));
      auto kernel_size = tensor_as<IntList>(std::move(peek(stack, 3, 11)));
      auto stride = tensor_as<IntList>(std::move(peek(stack, 4, 11)));
      auto padding = tensor_as<IntList>(std::move(peek(stack, 5, 11)));
      auto output_padding = tensor_as<IntList>(std::move(peek(stack, 6, 11)));
      auto dilation = tensor_as<IntList>(std::move(peek(stack, 7, 11)));
      auto output_mask = tensor_as<std::array<bool,3>>(std::move(peek(stack, 10, 11)));
  ...
  {"upsample_bilinear2d-1-output_size", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::upsample_bilinear2d(std::move(peek(stack, 0, 1)), output_size);
      drop(stack, 1);
      pack(stack, std::move(result));
      return 0;
  ...
  {"upsample_bilinear2d-2", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      AutoGPU device_guard(deviceForInputs(stack, 2));
      auto output_size = tensor_as<IntList>(std::move(peek(stack, 1, 2)));
      auto result = at::upsample_bilinear2d(std::move(peek(stack, 0, 2)), output_size);
      drop(stack, 2);
      pack(stack, std::move(result));
      return 0;
  ...
  {"upsample_bilinear2d_backward-1-input_size-output_size", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::upsample_bilinear2d_backward(std::move(peek(stack, 0, 1)), output_size, input_size);
      drop(stack, 1);
      pack(stack, std::move(result));
      return 0;
  ...
  {"upsample_bilinear2d_backward-3", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      autograd::profiler::RecordFunction record("upsample_bilinear2d_backward");
      AutoGPU device_guard(deviceForInputs(stack, 3));
      auto output_size = tensor_as<IntList>(std::move(peek(stack, 1, 3)));
      auto input_size = tensor_as<IntList>(std::move(peek(stack, 2, 3)));
      auto result = at::upsample_bilinear2d_backward(std::move(peek(stack, 0, 3)), output_size, input_size);
      drop(stack, 3);
      pack(stack, std::move(result));
      return 0;
  ...
  {"upsample_bilinear2d_forward-1-output_size", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::upsample_bilinear2d_forward(std::move(peek(stack, 0, 1)), output_size);
      drop(stack, 1);
      pack(stack, std::move(result));
      return 0;
  ...
  {"upsample_bilinear2d_forward-2", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      AutoGPU device_guard(deviceForInputs(stack, 2));
      auto output_size = tensor_as<IntList>(std::move(peek(stack, 1, 2)));
      auto result = at::upsample_bilinear2d_forward(std::move(peek(stack, 0, 2)), output_size);
      drop(stack, 2);
      pack(stack, std::move(result));
      return 0;
  ...
  {"upsample_linear1d-1-output_size", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::upsample_linear1d(std::move(peek(stack, 0, 1)), output_size);
      drop(stack, 1);
      pack(stack, std::move(result));
      return 0;
    }, "upsample_linear1d", 1);
  ...
  {"upsample_linear1d-2", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      AutoGPU device_guard(deviceForInputs(stack, 2));
      auto output_size = tensor_as<IntList>(std::move(peek(stack, 1, 2)));
      auto result = at::upsample_linear1d(std::move(peek(stack, 0, 2)), output_size);
      drop(stack, 2);
      pack(stack, std::move(result));
      return 0;
    }, "upsample_linear1d", 2);
  ...
  {"upsample_linear1d_backward-1-input_size-output_size", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::upsample_linear1d_backward(std::move(peek(stack, 0, 1)), output_size, input_size);
      drop(stack, 1);
      pack(stack, std::move(result));
      return 0;
  ...
  {"upsample_linear1d_backward-3", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto output_size = tensor_as<IntList>(std::move(peek(stack, 1, 3)));
      auto input_size = tensor_as<IntList>(std::move(peek(stack, 2, 3)));
      auto result = at::upsample_linear1d_backward(std::move(peek(stack, 0, 3)), output_size, input_size);
      drop(stack, 3);
      pack(stack, std::move(result));
      return 0;
  ...
  {"upsample_linear1d_forward-1-output_size", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::upsample_linear1d_forward(std::move(peek(stack, 0, 1)), output_size);
      drop(stack, 1);
      pack(stack, std::move(result));
      return 0;
  ...
  {"upsample_linear1d_forward-2", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      AutoGPU device_guard(deviceForInputs(stack, 2));
      auto output_size = tensor_as<IntList>(std::move(peek(stack, 1, 2)));
      auto result = at::upsample_linear1d_forward(std::move(peek(stack, 0, 2)), output_size);
      drop(stack, 2);
      pack(stack, std::move(result));
      return 0;
  ...
  {"upsample_trilinear3d-1-output_size", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::upsample_trilinear3d(std::move(peek(stack, 0, 1)), output_size);
      drop(stack, 1);
      pack(stack, std::move(result));
      return 0;
  ...
  {"upsample_trilinear3d-2", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      AutoGPU device_guard(deviceForInputs(stack, 2));
      auto output_size = tensor_as<IntList>(std::move(peek(stack, 1, 2)));
      auto result = at::upsample_trilinear3d(std::move(peek(stack, 0, 2)), output_size);
      drop(stack, 2);
      pack(stack, std::move(result));
      return 0;
  ...
  {"upsample_trilinear3d_backward-1-input_size-output_size", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::upsample_trilinear3d_backward(std::move(peek(stack, 0, 1)), output_size, input_size);
      drop(stack, 1);
      pack(stack, std::move(result));
      return 0;
  ...
  {"upsample_trilinear3d_backward-3", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto output_size = tensor_as<IntList>(std::move(peek(stack, 1, 3)));
      auto input_size = tensor_as<IntList>(std::move(peek(stack, 2, 3)));
      auto result = at::upsample_trilinear3d_backward(std::move(peek(stack, 0, 3)), output_size, input_size);
      drop(stack, 3);
      pack(stack, std::move(result));
      return 0;
  ...
  {"upsample_trilinear3d_forward-1-output_size", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      auto result = at::upsample_trilinear3d_forward(std::move(peek(stack, 0, 1)), output_size);
      drop(stack, 1);
      pack(stack, std::move(result));
      return 0;
  ...
  {"upsample_trilinear3d_forward-2", [](Node *node) {
    ...
    return TensorOp([=](Stack & stack) {
      ...
      AutoGPU device_guard(deviceForInputs(stack, 2));
      auto output_size = tensor_as<IntList>(std::move(peek(stack, 1, 2)));
      auto result = at::upsample_trilinear3d_forward(std::move(peek(stack, 0, 2)), output_size);
      drop(stack, 2);
      pack(stack, std::move(result));
      return 0;
